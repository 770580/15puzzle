	...
	var Game = function () {
	  ...
	  (0, _createClass3.default)(Game, [{
	    ...
	    value: function start() {
	      var items = this.container.querySelectorAll('.gridItem');
	      var blankSquare = this.container.querySelector('#blank');
	      var blankPosition = [].concat((0, _toConsumableArray3.default)(items)).indexOf(blankSquare);
	      this.activeItems = {
	        blank: blankSquare,
	    ...
	    value: function move(event) {
	      ...
	      if (key === 'ArrowDown') {
	        ...
	        var tempElem = this.activeItems.blank.cloneNode();
	      ...
	      if (key === 'ArrowUp') {
	        ...
	        var _tempElem = this.activeItems.blank.cloneNode();
	        this.container.insertBefore(_tempElem, this.activeItems.bottom);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _support = __webpack_require__(32);
	...
	var Grid = function () {
	  function Grid(parentConteiner, size) {
	  ...
	  (0, _createClass3.default)(Grid, [{
	    ...
	    value: function generate() {
	      ...
	      for (var i = 1; i < Math.pow(this.size, 2); i += 1) {
	        gridItems.push(i);
	      }

	      gridItems = (0, _support2.default)(gridItems);
	      gridItems.push('');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var size = 4;
	var grid = new _grid2.default(parentContainer, size);
	grid.generate();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = !__webpack_require__(2) && !__webpack_require__(22)(function(){
